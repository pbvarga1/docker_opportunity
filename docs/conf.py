...
htmlhelp_basename = 'opportunitydoc'
...
latex_documents = [
    (master_doc, 'opportunity.tex', 'opportunity Documentation',
     'Perry Vargas', 'manual'),
]
...
man_pages = [
    (master_doc, 'opportunity', 'opportunity Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'opportunity', 'opportunity Documentation',
     author, 'opportunity', 'One line description of project.',
     'Miscellaneous'),
]
